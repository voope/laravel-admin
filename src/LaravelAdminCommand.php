...
class LaravelAdminCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $this->call('vendor:publish', ['--provider' => 'Voope\CrudGenerator\CrudGeneratorServiceProvider', '--force' => true]);
        $this->call('vendor:publish', ['--provider' => 'Voope\LaravelAdmin\LaravelAdminServiceProvider', '--force' => true]);
...
Route::get('admin/generator', ['uses' => '\Voope\LaravelAdmin\Controllers\ProcessController@getGenerator']);
Route::post('admin/generator', ['uses' => '\Voope\LaravelAdmin\Controllers\ProcessController@postGenerator']);
